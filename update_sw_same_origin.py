...
# 1. Update root sw.js
root_sw_content = """const SKIP = /^(data:|blob:|javascript:|#|mailto:)/i;
...
public_sw_content = """const SKIP = /^(data:|blob:|javascript:|#|mailto:)/i;
...
with open("sw.js", "w") as f:
    f.write(root_sw_content)
print("Updated sw.js")

with open("public/sw.js", "w") as f:
    f.write(public_sw_content)
print("Updated public/sw.js")
